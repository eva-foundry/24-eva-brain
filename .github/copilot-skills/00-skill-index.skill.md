...
# Skill Index -- EVA Brain (v1 — retired)

> This is the skills menu for 24-eva-brain.
...
**Goal**: Original EVA brain prototype — superseded by 33-eva-brain-v2
**37-data-model record**: `GET /model/projects/24-eva-brain`
